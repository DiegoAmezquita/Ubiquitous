...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        if (useLongToday) {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), defaultImage);
            Asset asset = Utility.createAssetFromBitmap(bitmap);

            WearInfo wearInfo = new WearInfo(highString,lowString,asset);

            WearSync.getInstance(mContext).sendWeatherInfo(wearInfo);
        }
