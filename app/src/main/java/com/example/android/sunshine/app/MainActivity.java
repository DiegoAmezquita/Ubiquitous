...
import com.example.android.sunshine.app.wear.WearInfo;
...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback {
     ...
     */
    static final String PROJECT_NUMBER = "838412553275";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wearSync = WearSync.getInstance(this);
...
//            startActivity(new Intent(this, SettingsActivity.class));
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_fog);
            Asset asset = Utility.createAssetFromBitmap(bitmap);

            WearInfo wearInfo = new WearInfo("10", index + "", asset);

            WearSync.getInstance(this).sendWeatherInfo(wearInfo);
